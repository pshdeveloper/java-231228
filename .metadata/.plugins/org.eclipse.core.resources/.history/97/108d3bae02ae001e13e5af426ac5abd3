...
public class A_Array01 {
	...
	public static void main(String[] args) {
		...
		// 요소: 배열 내의 각각의 데이터
		System.out.println(array); // [I@3d012ddd: 배열이 담김 주소
...
//		System.out.println(array[3]); - Error
		...
		// 배열의 첫 번쨰 요소부터 마지막 요소까의 수 만큼 반복
		// 마지막 요소의 인덱스 = 배열의 길이 -1
		System.out.println("for 문을 사용한 배열의 순회");
...
//		}
		...
		System.out.println("for 문을 사용한 배열의 순회2");
...
//		myArray 배열에 8이 존재하는지 확인
		...
		for (int i = 0; i < originalLenght; i++) {
			...
			// [1]
			// [1, 2]
			// i 가 2일 경우 continue 문을 만나 k 가 증가 X
			// i 가 3일 경우 k 는 2
			// : result[2] = original[3]
			// [1, 2, 4]
		}
