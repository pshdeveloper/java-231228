...
import parentPackage.ParentPackage;
...
// ㅣ >> default(기본 값)으료 지정

//! 접근 제어자의 범위
// public > protected > (default) > private

// private: 같은 클래스 내에서만 접근 가능
// protected: 같은 패키ㅏ지 내에서, 그리고 다른 패키지의 자손 클래스에서 접근이 가능
...
class ProtectedClass extends ParentPackage{
