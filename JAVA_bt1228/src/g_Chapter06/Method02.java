...
// 반환 타입(return type)
// : 메서드의 작업 수행 결과(출력)인 반환값의 타입을 명시
...
// : 해당 반환 값은 반환타입과 일치하거나 적어도 자동 형변환이 가능한 것

// : return 문은 단 하나의 값만을 반환 가능
...
public class Method02 {
	...
	// maim: 메서드 명
	// (String[] args): 메서드의 매개변수로 String 타입의 배열을 전달 받음
	// - 자바 설치 시
	...
	public static void main(String[] args) {
		...
		// int add(int x, int y)를 호출하고 결과를 result 에 저장
