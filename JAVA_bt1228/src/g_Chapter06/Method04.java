...
// 정적 메서드
// : 메서드 앞에 static 키워들르 붙이는 경우 클래스(정적)메서드 생성 가능
...
// static 사용 권장 사항
// 1. 클레스 설계 시, 변수(속성) 중 모든 인스턴스가 공통적으로 사용하는 값
// 2. 클래스 변수는 인스턴스 생성 없이도 사용 가능 
// 3. 클래스 메서드는 인스턴스 변수를 사용할 수 없다
// - 클래스 메서드 내에서 인스턴스 변수 호출(사용X)
// 4. 메서드 내에서 인스턴스 변수를 사용하지 X, static 을 붙이는 것을 고려
...
class Operator {
	...
	// 인스턴스 메서드: 인스턴스 변수인 a, b 가 필요한 작업
	// - 매개변수가 필요 X
	...
	// 정적 메서드: 인스턴스 변수와 관계 없이 매개변수마으로 작업 가능
