...
class Car {
	...
	// 생성자 내에서 매개변수와 초기화 하려는 인스턴스 변수의 이름이 동일한 경우
	...
	Car(String color) {
		...
		// this()함수 - 해당 생성자 메서드를 가르킴
		this(color, "auto", 4);
		door = 5; //  인스턴스 변수 초기화
//		Car(color, "auto", 4); // - 첫번째 줄에서 호출 X / this 키워드 사용 X - error
	}
