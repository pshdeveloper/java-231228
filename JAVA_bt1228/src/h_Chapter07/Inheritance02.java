...
// 자식 클래스이 객체를 생성할 떄, 자식 클래스는 자식 생성자를 통해 자식 객체 생성
...
public class Inheritance02 {
	...
	public static void main(String[] args) {
		...
		// : 단, 항상 직접적으로 정의된 생성자를 필요로 하는 것은 아니다
		Cat voidCat = new Cat();
		Cat myCat = new Cat("choco");
		
		// 자식 클래스의 name  호출 후
		// 위의 인스턴스 생성 시 부모 클래스로 전달했떤 choco 이름의 
		// , 부모 클래스의 name 이 호출
		myCat.greet();
	}
...
// super
// : 자식 클래스에서 부모 클래스의 멤버(필드, 메서드)에 접근할 떄 사용'
