...
//: 멤버 변수 선언부에 위치
//: static 키워드가 X
//: 외부 클래스의 객체를 먼저 생성한 후에 내부 클래스 객체 생성이 가능
...
class Order1 {
	...
	class OrderDetail {
		...
		void amountCheeze() {
			// 외부 클래스의 멤버에 접근 가능
			// : 외부클래스.this.형식: 명시적으로 외부 클래스의 인스턴스에 접근
			System.out.println(Order1.this.pasta + cheeze);
...
public class B_InstanceClass {
	public static void main(String[] args) {
		...
		// 내부 클래스 인스턴스화
		// : 외부클래스.내부클래스 형식으로 내부 클래스를 생성
		Order1.OrderDetail orderDetail = order.new OrderDetail();
