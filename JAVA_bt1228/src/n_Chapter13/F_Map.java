...
// 2. LinkedHashMap
// : 삽입 순서를 유지
// : 요소의 삽입 순서가 중요하고 빠른 검색이 필요할 떄 주로 사용

// 3. TreeMap
// : 키-값 쌍을 트리에 저장, 키에 따라 정렬되어 저장
// : 키에 null 값 허용 X (값은 그대로 허용)
...
public class F_Map {
	public static void main(String[] args) {
		...
		// containsKey(Object key): 주어진 키가 Map 에 있는지 확인하여 boolean 으로 반환
		// keySet(): Map 의 키 Set 을 반환
		// values(): Map 의 값 컬렉션을 반환
		// entrySet(): Map 의 키-값 쌍을 나타내는 Set 반환
		...
		// 값 제거
		students.remove("Seungha");
		System.out.println(students);
		
		// 키를 통한 값을 검사
		System.out.println(students.containsKey("JUHEON"));
