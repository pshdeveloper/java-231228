...
// - Char 스트림: 문자 단위로 파일을 읽고 처리 (문자 데이터만 처리 가능)
...
public class A_IO01 {
	public static void main(String[] args) {
		...
		// Buffer(버퍼)
		// : 임시 저장 공간
		// : A와 B가 서로 입출력을 수행할 떄, 그 속도 차이를 극복하기 위한 임시 저장 공간
		...
		try {
			...
			// printStackTrace()
			// : 예외의 발생 당시에 호출 스택에 있던 메서드 정보를 예외 결과창에 출력
